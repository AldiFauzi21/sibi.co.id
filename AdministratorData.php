...
$admin = query("SELECT * FROM administrator ");
...
if ( isset($_POST["kategori"]) ) {//post karena methodnya post, yang mau dicek adalah tombol cari berdasrkan name yg ditulis di form
	...
	$admin= cari2($_POST["kategori"]); //jadi nanti $pengguna akan berisi data hasil pencarian dari function cari, lalu function cari ini mendapatkan data dari apapun yang diketikkan pengguna 
...
<!--Daftar Pengguna-->
              ...
              <div class="jumbotron jumbotron-fluid">
                ...
                <div class="container">
                  ...
                  <h4 class="display-4">Daftar Administrator</h4>
